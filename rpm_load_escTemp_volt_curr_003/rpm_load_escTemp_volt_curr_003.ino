...
// ==========================================
const float VOLTAGE_MULTIPLIER = 19.02; // Calibrated for your 58.6V battery
const float CURRENT_MULTIPLIER = 60.6;  // Ensure this matches your paper card
...
void loop() {
  ...
  if (currentMillis - previousPrintMillis >= printInterval) {
    ...
    // ==========================================
    // 4. GATHER VOLTAGE & CURRENT (OVERSAMPLED)
    // ==========================================
    long sumV = 0;
    long sumI = 0;
    const int numSamples = 20; // Take 20 rapid snapshots to crush the noise
    ...
    // Calculate the perfect mathematical average
    ...
    // Phantom Amp Filter: Ignore background noise below 0.5A
