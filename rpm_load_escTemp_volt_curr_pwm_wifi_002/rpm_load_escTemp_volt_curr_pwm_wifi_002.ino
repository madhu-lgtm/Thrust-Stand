        ...
        if (c == '\n') {
          if (currentLine.length() == 0) {
            ...
            if (isDataRequest) {
              ...
              // Send Beautiful UI via Raw String Literal
              client.println("HTTP/1.1 200 OK");
              ...
              // -----------------------------------------------------------------
              // PURE HTML/JS/CSS PAYLOAD (No external libraries required)
              // -----------------------------------------------------------------
              client.print(R"=====(
<!DOCTYPE html>
<html>
  ...
  <script>
    ...
    function drawSparkline(id, arr, col) {
      ...
      for(let i = 0; i < arr.length; i++) {
        ...
        // Pad slightly to keep line inside canvas
