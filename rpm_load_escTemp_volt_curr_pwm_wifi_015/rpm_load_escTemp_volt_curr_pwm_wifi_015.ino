...
<head>
  ...
  <style>
    ...
    .nav-left { display: flex; align-items: center; gap: 20px; width: 300px; } /* Fixed width helps center the middle text */
    ...
    /* --- NEW CENTERED TITLE --- */
    .nav-center { flex: 1; text-align: center; color: #ffffff; font-size: 24px; font-weight: 800; letter-spacing: 2px; }

    .nav-right { display: flex; align-items: center; justify-content: flex-end; gap: 12px; width: 450px; } /* Fixed width helps center the middle text */
